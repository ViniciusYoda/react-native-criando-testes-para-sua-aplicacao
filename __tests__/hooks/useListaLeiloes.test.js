...
import { obtemLeiloes } from '../../src/repositorio/obtemLeiloes';
...
describe('hooks/useListaLeioloes', () => {

   it('deve retornar uma  lista deleilões e umma função para atualizar', async () => {
